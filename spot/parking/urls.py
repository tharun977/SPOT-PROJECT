...
urlpatterns = [
    ...
    path('parking-slot/new/', views.parking_slot_create, name='parking_slot_create'),
    path('parking-slot/edit/<int:pk>/', views.parking_slot_update, name='parking_slot_update'),
    path('parking-slot/view/<int:pk>/', views.parking_slot_view, name='parking_slot_view'),
    path('parking-slot/delete/<int:pk>/', views.parking_slot_delete, name='parking_slot_delete'),
